...
const Login = () => {
  ...
  const fetchUserData = async (token) => {
    const response = await fetch("https://freelancer-clone-backend.onrender.com/api/auth/getuser", {
      method: "POST",
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://freelancer-clone-backend.onrender.com/api/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
