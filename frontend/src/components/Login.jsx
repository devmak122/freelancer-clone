...
const Login = (props) => {
  ...
  const fetchUserData = async (token) => {
    const response = await fetch("https://freelancer-clone-g6ee.vercel.app/api/auth/getuser", {
      method: "POST",
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://freelancer-clone-g6ee.vercel.app/api/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
